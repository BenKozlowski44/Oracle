...
export function CommandInventoryCard({ oracleData }: { oracleData: OracleCommand[] }) {
    return (
        <div className="rounded-xl border bg-card text-card-foreground shadow p-6 border-l-4 border-l-[#c9a227]">
...
export function PipelineHealthCard({ oracleData }: { oracleData: OracleCommand[] }) {
    ...
    return (
        <Link to="/oracle" className="block rounded-xl border bg-card text-card-foreground shadow p-6 border-l-4 border-l-[#c9a227] hover:bg-muted/30 transition-colors">
