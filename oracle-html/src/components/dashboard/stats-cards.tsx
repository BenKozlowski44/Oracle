...
export function PipelineHealthCard({ oracleData }: { oracleData: OracleCommand[] }) {
    ...
    return (
        <Link to="/oracle" className="block rounded-xl border bg-card text-card-foreground shadow p-6 border-l-4 border-l-[#c9a227] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(201,162,39,0.18)] hover:border-l-[#f0c040] hover:bg-muted/30 transition-colors">
